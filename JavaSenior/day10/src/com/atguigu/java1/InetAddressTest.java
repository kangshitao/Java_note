...
public class InetAddressTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(inet2); //www.atguigu.com/58.205.221.11
            ...
            System.out.println(inet4); //SuperAI/192.168.198.1
            System.out.println(inet4.getHostAddress()); //192.168.198.1
            System.out.println(inet4.getHostName()); //SuperAI

            //getHostName()
            System.out.println(inet2.getHostName()); // www.atguigu.com
            //getHostAddress()
            System.out.println(inet2.getHostAddress()); //58.205.221.11
